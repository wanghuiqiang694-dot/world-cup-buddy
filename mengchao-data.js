...
// 数据来源：官方报道及多家体育媒体，更新至第6轮（2026-06-22）

// ========== 球队信息 ==========
const MENGCHAO_TEAMS = {
  '赤峰': { name: '赤峰队', city: '赤峰市', venue: '赤峰体育中心', color: '#ff7800', strength: 78, desc: '本赛季领头羊，前6轮5胜1平保持不败' },
  '鄂尔多斯': { name: '鄂尔多斯队', city: '鄂尔多斯市', venue: '鄂尔多斯市体育事业发展中心体育场', color: '#26a269', strength: 76, desc: '3胜3平零负，仅失2球，防守最佳' },
  '通辽': { name: '通辽队', city: '通辽市', venue: '通辽市奥体中心', color: '#e01b24', strength: 75, desc: '与鄂尔多斯同积12分，净胜球劣势排第三' },
  '乌兰察布': { name: '乌兰察布队', city: '乌兰察布市', venue: '乌兰察布市体育场', color: '#813d9c', strength: 72, desc: '进攻火力凶猛，6轮打入11球' },
  '包头': { name: '包头队', city: '包头市', venue: '包头市奥体中心足球场', color: '#1a5fb4', strength: 70, desc: '第4轮4:0大胜乌兰察布，进攻效率高' },
  '阿拉善盟': { name: '阿拉善盟队', city: '阿拉善盟', venue: '阿左旗巴彦浩特多功能体育场', color: '#f5c211', strength: 65, desc: '3胜1平2负，中游位置' },
  '巴彦淖尔': { name: '巴彦淖尔队', city: '巴彦淖尔市', venue: '巴彦淖尔市足球主题公园', color: '#33d17a', strength: 64, desc: '开门红后遭遇4连败' },
  '呼和浩特': { name: '呼和浩特队', city: '呼和浩特市', venue: '呼和浩特体育场', color: '#1c71d8', strength: 68, desc: '上届冠军，前5轮一胜难求，第6轮3:2逆转阿拉善获首胜' },
  '兴安盟': { name: '兴安盟队', city: '兴安盟', venue: '兴安盟体育场', color: '#a51d2d', strength: 62, desc: '揭幕战客场取胜后状态低迷' },
  '锡林郭勒盟': { name: '锡林郭勒盟队', city: '锡林郭勒盟', venue: '锡林郭勒盟体育场', color: '#c01c28', strength: 60, desc: '第6轮6:0大胜乌海获首胜' },
  '呼伦贝尔': { name: '呼伦贝尔队', city: '呼伦贝尔市', venue: '呼伦贝尔学院体育场', color: '#99c1f1', strength: 66, desc: '开局两连败后渐有起色' },
  '乌海': { name: '乌海队', city: '乌海市', venue: '乌海市第一中学体育场', color: '#5c3566', strength: 58, desc: '6轮仅2分，排名垫底' }
};

// ========== 积分榜（截至第6轮，2026-06-22） ==========
const MENGCHAO_STANDINGS = [
  { rank: 1,  team: '赤峰',     played: 6, won: 5, drawn: 1, lost: 0, gf: 15, ga: 6,  pts: 16 },
  { rank: 2,  team: '鄂尔多斯', played: 6, won: 3, drawn: 3, lost: 0, gf: 12, ga: 2,  pts: 12 },
  { rank: 3,  team: '通辽',     played: 6, won: 3, drawn: 3, lost: 0, gf: 9,  ga: 4,  pts: 12 },
  { rank: 4,  team: '乌兰察布', played: 6, won: 3, drawn: 2, lost: 1, gf: 11, ga: 8,  pts: 11 },
  { rank: 5,  team: '包头',     played: 6, won: 3, drawn: 1, lost: 2, gf: 8,  ga: 4,  pts: 10 },
  { rank: 6,  team: '阿拉善盟', played: 6, won: 3, drawn: 1, lost: 2, gf: 9,  ga: 8,  pts: 10 },
  { rank: 7,  team: '巴彦淖尔', played: 6, won: 2, drawn: 1, lost: 3, gf: 6,  ga: 10, pts: 7 },
  { rank: 8,  team: '呼和浩特', played: 6, won: 1, drawn: 2, lost: 3, gf: 7,  ga: 11, pts: 5 },
  { rank: 9,  team: '兴安盟',   played: 6, won: 1, drawn: 2, lost: 3, gf: 3,  ga: 9,  pts: 5 },
  { rank: 10, team: '锡林郭勒盟', played: 6, won: 1, drawn: 1, lost: 4, gf: 8,  ga: 9,  pts: 4 },
  { rank: 11, team: '呼伦贝尔', played: 6, won: 1, drawn: 1, lost: 4, gf: 6,  ga: 11, pts: 4 },
  { rank: 12, team: '乌海',     played: 6, won: 0, drawn: 2, lost: 4, gf: 2,  ga: 15, pts: 2 }
];
...
const MENGCHAO_MATCHES = [
  ...
  { id: 'mc32', round: 6, home: '通辽',     away: '包头',     date: '2026-06-20', time: '19:30', venue: '通辽市奥体中心', homeScore: 2, awayScore: 0, finished: true },
  { id: 'mc33', round: 6, home: '乌兰察布', away: '兴安盟',   date: '2026-06-20', time: '16:00', venue: '乌兰察布市体育场', homeScore: 2, awayScore: 0, finished: true },
  { id: 'mc34', round: 6, home: '赤峰',     away: '呼伦贝尔', date: '2026-06-20', time: '19:00', venue: '赤峰体育中心', homeScore: 4, awayScore: 2, finished: true },
  ...
  { id: 'mc36', round: 6, home: '锡林郭勒盟', away: '乌海',   date: '2026-06-21', time: '17:00', venue: '锡林郭勒盟体育场', homeScore: 6, awayScore: 0, finished: true },
...
// ========== 射手榜（截至第6轮，2026-06-22） ==========
const MENGCHAO_SCORERS = [
  { rank: 1,  name: '王闵捷', team: '赤峰',     goals: 7, note: '含1粒点球' },
  { rank: 2,  name: '希力德格', team: '赤峰',   goals: 3, note: '' },
  { rank: 3,  name: '叶重秋', team: '赤峰',     goals: 3, note: '' },
  { rank: 4,  name: '吴宇帆', team: '鄂尔多斯', goals: 3, note: '' },
  { rank: 5,  name: '冯炜博', team: '鄂尔多斯', goals: 2, note: '第六轮建功' },
  { rank: 6,  name: '宝音门德', team: '呼伦贝尔', goals: 2, note: '' },
  { rank: 7,  name: '周鹏程', team: '乌兰察布', goals: 2, note: '' },
  { rank: 8,  name: '阿尔什恩', team: '鄂尔多斯', goals: 2, note: '' },
  { rank: 9,  name: '高建宇', team: '鄂尔多斯', goals: 1, note: '第六轮凌空垫射' },
  { rank: 10, name: '宝满',   team: '呼和浩特', goals: 1, note: '第六轮扳平进球' },
  { rank: 11, name: '孟克特尔文', team: '呼和浩特', goals: 1, note: '第六轮绝杀' },
  { rank: 12, name: '陈鸿宇', team: '呼和浩特', goals: 1, note: '第六轮首开记录' }
];
